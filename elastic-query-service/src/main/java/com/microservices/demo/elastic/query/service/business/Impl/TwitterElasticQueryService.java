...
public class TwitterElasticQueryService implements ElasticQueryService {
   ...
   // private final ElasticToResponseModelTransformer elasticToResponseModelTransformer;
    ...
    public TwitterElasticQueryService(ElasticToResponseModelTransformer elasticToResponseModelTransformer, ElasticQueryServiceResponseModelAssembler assembler, ElasticQueryClient<TwitterIndexModel> elasticQueryClient) {
    ...
    public List<ElasticQueryServiceResponseModel> getDocumentsByText(String text) {
       ...
       // return elasticToResponseModelTransformer.getResponseModels(elasticQueryClient.getIndexModelByText(text));
        return elasticQueryServiceResponseModelAssembler.toModel(elasticQueryClient.getIndexModelByText(text));
    }
    ...
    public List<ElasticQueryServiceResponseModel> getAllDocuments() {
       ...
       // return elasticToResponseModelTransformer.getResponseModels(elasticQueryClient.getAllIndexModels());
        return elasticQueryServiceResponseModelAssembler.toModel(elasticQueryClient.getAllIndexModels());
    }
}
