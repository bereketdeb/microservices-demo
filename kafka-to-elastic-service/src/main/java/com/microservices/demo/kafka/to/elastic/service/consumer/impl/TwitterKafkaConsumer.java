...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    @Autowired
    private KafkaListenerEndpointRegistry kafkaListenerEndpointRegistrar;
    ...
    public TwitterKafkaConsumer(KafkaAdminClient kafkaAdminClient, KafkaConfigData kafkaConfigData, KafkaConsumerConfigData kafkaConsumerConfigData, AvroToElasticModelTransformer avroToElasticModelTransformer, ElasticIndexClient<TwitterIndexModel> elasticIndexClient) {
    ...
    public void onAppStarted(ApplicationStartedEvent event){
        ...
        Objects.requireNonNull(kafkaListenerEndpointRegistrar.getListenerContainer(kafkaConsumerConfigData.getConsumerGroupId())).start();
    }
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        LOG.info("{} number of messages recieved with keys {}, partitions {} and offsets {}, sending it to elastic: Thread id {}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString(),
